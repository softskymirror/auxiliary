...
public class ParamResearcher extends JFrame{
    ...
    String [] mixDirection={"ͷ","β"};
    com.toolui.ViewAdapter va=new ViewAdapter();
    ByteUtils bU=new ByteUtils();
    JLabel title=new JLabel();//ֽڽ
    JLabel introduce=new JLabel();//ѡȡԴͣ
    JLabel cryptInfos=new JLabel();//ӽϢ
    JLabel cryptTool=new JLabel();//ܽѡ
    JLabel zipTool=new JLabel();//ѹѹѡ
    JLabel zipInfos=new JLabel();//ӽѹϢ
    JLabel editTool=new JLabel();//ֽ޸ѡ
    JLabel cutHexInfos=new JLabel();//ȡֽڱ
    JLabel inputHexInfos=new JLabel();//ֽڱ
    JLabel mixHexInfos=new JLabel();//ϳֽڱ
    JLabel copyright=new JLabel();//Ȩ
    JLabel fileTotalSize=new JLabel();//ļܴС
    JLabel fileTypes=new JLabel();//ļ

    JRadioButton jt1=new JRadioButton();//·
    JRadioButton jt2=new JRadioButton();//·
    JButton analysis=new JButton();//ݰť
    ...
    JRadioButton unGzip=new JRadioButton();//GZIPѹ
    ...
    JButton run=new JButton();//ִֽڲ
    JButton export=new JButton();//ļ
    JButton turnArround=new JButton();//λ
    JTextArea hexAddress=new JTextArea();//ʮڴַ
    JTextArea afterhexAddress=new JTextArea();//ʮڴַ
    JTextArea hexArea=new JTextArea();//ʮ
    JTextArea strArea=new JTextArea();//UTF-8ֱ
    JTextArea afterhexArea=new JTextArea();//ʮ
    JTextArea afterstrArea=new JTextArea();//UTF-8ֱ
    JTextArea cryptpwd=new JTextArea();//Կ
    JTextArea cutStart=new JTextArea();//üʼ
    ...
    ButtonGroup cryptGroup=new ButtonGroup();//ӽܵѡ
    ButtonGroup codeGroup=new ButtonGroup();//ӽѹѡ
    ButtonGroup editGroup=new ButtonGroup();//ֽ޸ѡ
    JPanel byteViewPanel=new JPanel();//byteͼ
    JPanel afterByteViewPanel=new JPanel();//byteͼ
    ...
    va.generateJLabel(introduce, 20,80,250,20, "ѡȡԴķʽ", 15,false);
    va.generateJLabel(state, 20,780, 1920,50,"testing area",12,false);
    va.generateJLabel(cryptTool, 680, 200, 150, 25, "ӽѡ", 15, false);
    ...
    va.generateJLabel(mixHexInfos, 780, 480, 450, 25, "ϲλ                                ϲƬ", 15, false);
    ...
    va.generateJButton(analysis, 400, 120, 100, 25,"", 12,true,new ActionListener(){
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(path.equals("")){
            JOptionPane.showMessageDialog(null, "ļַΪ");
            }else{   
            ...
            try{
                ...
                state.setText("ɹ,ļС"+filesbytes.length+"byte");

            }catch(Exception ec){
                JOptionPane.showMessageDialog(null, "δҵָļ");
                 ec.printStackTrace();
            }    
        }
    ...
    va.generateJButton(run, 1240,570,120,50,"ִв",12,false,new ActionListener(){
        @Override
        public void actionPerformed(ActionEvent e) {
            // TODO Auto-generated method stub
            try {
    ...
    va.generateJButton(export, 1060,570,120,50,"ļ",12,true,new ActionListener(){
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if(bU.bytes!=null)
            ...
            JOptionPane.showMessageDialog(null,"Ϊգ޷ļ");
