  ...
  public static void generateJTree(int location_x,int location_y,int width,int height,String root,String []FirstTree,String [][] SecondTree,JPanel jpanel){
   ...
   // ڵɱ༭
    ...
    public void valueChanged(TreeSelectionEvent e) {
      System.out.println("ǰѡеĽڵ: " + e.getPath());
    }
    });
    // 壬ΪڵչҪܴĿռʾҪһ
...
public static int byte2Int(byte[] res){
  int targets = (res[0] & 0xff) | ((res[1] << 8) & 0xff00) // | ʾλ 
  | ((res[2] << 24) >>> 8) | (res[3] << 24); 
  return targets;
}
...
public static byte[] int2byte(int res) {  
    ...
    targets[1] = (byte) ((res >> 8) & 0xff);// ελ   
    targets[2] = (byte) ((res >> 16) & 0xff);// θλ   
...
public static void printHexString(byte [] b){
  ...
  public String gZip(String input) throws UnsupportedEncodingException {
    ...
    return new String(Base64.encodeBase64(bytes),"ISO-8859-1");//ֱӷֱδBase64ܵıֽڽ
  }
