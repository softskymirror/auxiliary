...
public class ByteUtils {
  ...
  public static void setFrame(String[] args) {
    ...
    generateJTree(0,0,250,650,"网络设置",new String[]{"下载设置","连接设置"},new String[][]{},jpanel);
    jf.setContentPane(jpanel);
    jf.setVisible(true);
  }
  public static void generateJTree(int location_x,int location_y,int width,int height,String root,String []FirstTree,String [][] SecondTree,JPanel jpanel){
   ...
   /*  for(int j=0;j<secondtree.length;j++){
...
public static void printHexString(byte [] b){
  ...
  public String gZip(String input) throws UnsupportedEncodingException {
    ...
    return new String(Base64.encodeBase64(bytes),"ISO-8859-1");//若直接返回直接未经Base64加密的文本字节将导致乱码
  }
 ...
 */
  public String unGZip(String base64unZipInput) {
    ...
    e.printStackTrace();
    JOptionPane.showMessageDialog(null, "解压出错");
    } finally {
    try {
      if (gzip != null)
        gzip.close();
...
public static byte[] byteMerger(byte[] bt1, byte[] bt2){ 
  ...
  for(byte bt: bt2){
   ...
   i++;
     ...
     * @throws Exception
     */
 public static String getByteString(byte [] bytes,String charset) throws Exception{
  String hex=new String(bytes,charset);
  return hex;
 }
     ...
     * @throws Exception
     */
    public static byte [] getStringBytes(String text,String charset) throws Exception{
